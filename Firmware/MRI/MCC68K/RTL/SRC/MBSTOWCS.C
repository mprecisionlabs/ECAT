...
/************************************************************************/
/*	mbstowcs (const wchar_t *pwcs, const char *s, size_t n)		*/
/*		pwcs - destination wide character			*/
/*		s - source address of multibyte character		*/
...
register size_t	count;
    ...
    while (count) {
	if ((*pwcs = *s) == '\0') break;	/* stop if null found */
	--count;
	++s;
	++pwcs;
	}
